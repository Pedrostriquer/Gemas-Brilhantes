...
import '../GemasBrilhantes/StoreLayout.css'; // Aponta para o mesmo CSS compartilhado
...
const Joias = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                // 2. Buscar Grupos de Atributos que se aplicam a 'joia'
    ...
    useEffect(() => {
        // Filtra inicialmente apenas por produtos do tipo 'joia'
