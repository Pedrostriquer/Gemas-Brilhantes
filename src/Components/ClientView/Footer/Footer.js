            ...
            <div className="footer-container">
                ...
                <div className="footer-column">
                    ...
                    <div className="social-links">
                        {footerData.instagram && <a href={footerData.instagram} target="_blank" rel="noopener noreferrer"><i className="fab fa-instagram"></i></a>}
                        {footerData.facebook && <a href={footerData.facebook} target="_blank" rel="noopener noreferrer"><i className="fab fa-facebook-f"></i></a>}
                    </div>
                </div>
            </div>
